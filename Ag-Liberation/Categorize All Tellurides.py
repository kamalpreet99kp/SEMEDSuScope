...
def classify_mineral(row):
    ...
    # 3) Au+Ag (Electrum) (allows sulphide host association if Te is low)
    if (5 <= au <= 98 and 5 <= ag <= 98 and te < 3 and bi < 3 and
            pb < MINOR and se < TRACE and hg < TRACE and sb < TRACE and ars < TRACE and
            s < 30 and cu < 40 and fe < 40):
    ...
    # 5) Calaverite
    if (30 <= au <= 55 and 35 <= te <= 70 and ag < 10 and bi < 8 and
            pb < MINOR and s < 12 and se < TRACE and hg < TRACE and sb < TRACE and
            ars < TRACE and cu < TRACE and fe < TRACE):
        return "Calaverite"

    # 6) Sylvanite/Krennerite
    if (45 <= te <= 63 and 15 <= au <= 42 and 3 <= ag <= 18 and
            bi < MINOR and pb < MINOR and s < 12 and se < TRACE and hg < TRACE and
            sb < TRACE and ars < TRACE and cu < TRACE and fe < TRACE):
        return "Sylvanite/Krennerite"

    # 7) Petzite
    if (25 <= ag <= 52 and 22 <= te <= 42 and 14 <= au <= 33 and
            bi < MINOR and pb < MINOR and s < 10 and se < TRACE and hg < TRACE and
            sb < TRACE and ars < TRACE and cu < TRACE and fe < TRACE):
        return "Petzite"
    ...
    # 14) Acanthite
    if ag > 10 and s > 7 and hg < 7 and te < 6 and au < 8 and se < 6 and bi < 40 and sb < 8 and ars < 8 and cu < 25 and fe < 26:
        return "Acanthite"

    # 15) Imiterite
    if 5 < ag < 75 and 5 < s < 31 and 6.99 < hg < 53 and te < 6 and au < 8 and sb < 15 and ars < 15 and bi < 40 and cu < 25 and fe < 26 and se < 6:
        return "Imiterite"
    ...
    if au > AUAG_CUTOFF and te < 5 and (s > 5 or fe > 10 or cu > 10):
        return "Au Associations with Sulphides"

    # 24) Ag Associations with Sulphides
    if ag > AUAG_CUTOFF and te < 5 and (s > 5 or fe > 10 or cu > 10):
    ...
    # Unidentified is reserved for telluride-like leftovers only
    if te > 2:
        return "Unidentified"
    return None
