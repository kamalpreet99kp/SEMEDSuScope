...
Public Sub CreateAuWordReportFromWorkbook()
    ...
    orientationChoice = InputBox( _
        ...
        "1")
    pageOrientation = OrientationFromChoice(orientationChoice)
...
CleanUp:
    ...
    If exportSucceeded Then MsgBox "Word report saved:" & vbCrLf & outputPath, vbInformation, "Au Word Report"
    Exit Sub
